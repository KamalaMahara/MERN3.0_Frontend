...
const Cards = ({ blog }) => {
  return (
    ...
    <div className="bg-neutral-primary-soft block max-w-sm p-6 border border-default hover:border-green-400 rounded-lg shadow-xs">
      <a href="#">
        <img className="rounded-base w-full h-50" src={"http://localhost:3000/" + blog.image} alt="" />
      </a>
      <a href="#">
