            ...
            <div className="md:flex-1 px-4">
              ...
              <div className="flex -mx-2 mb-4">
                ...
                <div className="w-1/3 px-2">
                  <button className="w-full bg-gray-200 dark:bg-red-700 text-gray-800 dark:text-white py-2 px-4 rounded-full font-bold hover:bg-gray-300 dark:hover:bg-gray-600">Delete Blog</button>
                </div>
              </div>
            </div>
            <div className="md:flex-1 px-4">
